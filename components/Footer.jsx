...
export default function Footer() {
    return (
        <footer className="w-full p-4 border-t border-gray-200 lg:mt-3 md:mt-3 sm:mt-3 shadow md:flex md:items-center md:justify-between md:p-6 bg-black dark:border-gray-600">
